...
class OrderPanel extends StatelessWidget {
                ...
                return GridView(
                  ...
                  children: [
                    ...
                    orderList(
                        ...
                        7,
                        'Ngoc Thuong',
                        'https://tse1.mm.bing.net/th?id=OIP.1_MiVF-eEGHV1jmcWN41ZwHaHa&pid=Api',
                        '150,000',
                        'New'),
                    orderList(
                        count,
                        3,
                        'Quoc Doanh',
                        'https://tse1.mm.bing.net/th?id=OIP.XPBCGAgIos7b7aHzYics5AHaHa&pid=Api',
                        '80,000',
                        'Shipping'),
                    orderList(
                        count,
                        10,
                        'Tran Khoa',
                        'https://tse1.mm.bing.net/th?id=OIP.b0B1dMkxjQ85Uc6OYBErWgHaHa&pid=Api',
                        '700,000',
                        'Deliveried'),
                    orderList(
                        count,
                        21,
                        'Thanh Huy',
                        'https://tse1.mm.bing.net/th?id=OIP.5JNp6r7r2SIqxiLJ0XlcXwHaHa&pid=Api',
                        '1,200,000',
                        'Deliveried'),
                    orderList(
                        count,
  ...
  AnimationConfiguration orderList(
      int count, item, String title, img, price, status) {
    return AnimationConfiguration.staggeredList(
      ...
      child: SlideAnimation(
        ...
        child: FadeInAnimation(
          child: OrderTile(title, img, price, item, status),
        ),
      ),
    );
  }
